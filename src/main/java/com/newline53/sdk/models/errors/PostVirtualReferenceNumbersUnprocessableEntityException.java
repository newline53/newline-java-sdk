...
public class PostVirtualReferenceNumbersUnprocessableEntityException extends NewlineException {
    ...
    public PostVirtualReferenceNumbersUnprocessableEntityException(
                int code,
                byte[] body,
    ...
    /**
    * Parse a response into an instance of PostVirtualReferenceNumbersUnprocessableEntityException. If deserialization of the response body fails,
    ...
    */
    ...
    /**
    * Parse a response into an instance of PostVirtualReferenceNumbersUnprocessableEntityException asynchronously. If deserialization of the response body fails,
    * the resulting PostVirtualReferenceNumbersUnprocessableEntityException instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<PostVirtualReferenceNumbersUnprocessableEntityException> fromAsync(HttpResponse<Blob> response) {
        return response.body()
                ...
                .handle((bytes, err) -> {
                    ...
                    try {
                        return new PostVirtualReferenceNumbersUnprocessableEntityException(
                                response.statusCode(),
                                bytes,
                                response,
