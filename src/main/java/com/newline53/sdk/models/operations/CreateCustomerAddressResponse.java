...
public class CreateCustomerAddressResponse {
     ...
     * Maximum 35 characters
     */
    public CreateCustomerAddressResponse withStreet1(@Nullable String street1) {
        this.street1 = JsonNullable.of(street1);
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public CreateCustomerAddressResponse withStreet2(@Nullable String street2) {
     ...
     * Maximum 35 characters
     */
    public CreateCustomerAddressResponse withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public CreateCustomerAddressResponse withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public CreateCustomerAddressResponse withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCustomerAddressResponse other = (CreateCustomerAddressResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCustomerAddressResponse.class,
                "street1", street1,
                "street2", street2,
                "city", city,
                "state", state,
    ...
    public final static class Builder {
        ...
        public CreateCustomerAddressResponse build() {
