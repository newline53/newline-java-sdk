...
public class GetTransactionsUidInstantPaymentTransmitter {
     ...
     * Building number for Transmitter address. Alphanumeric only.
     */
    public GetTransactionsUidInstantPaymentTransmitter withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for Transmitter address
     */
    public GetTransactionsUidInstantPaymentTransmitter withStreet1(@Nonnull String street1) {
