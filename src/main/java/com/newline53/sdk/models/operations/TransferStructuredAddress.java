 ...
 */
public class TransferStructuredAddress {
    /**
    ...
    @JsonCreator
    public TransferStructuredAddress(
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public TransferStructuredAddress withLine1(@Nullable String line1) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public TransferStructuredAddress withLine2(@Nullable String line2) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public TransferStructuredAddress withBuildingNumber(@Nullable String buildingNumber) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public TransferStructuredAddress withStreetName(@Nullable String streetName) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public TransferStructuredAddress withCity(@Nonnull String city) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public TransferStructuredAddress withState(@Nullable String state) {
     ...
     * US ZIP code (5-digit) or ZIP+4.
     */
    public TransferStructuredAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public TransferStructuredAddress withCountry(@Nonnull String country) {
     ...
     * Name of the Transmitter.
     */
    public TransferStructuredAddress withName(@Nonnull String name) {
     ...
     * Up to 24 digits, supplied by Transmitter. Numeric only.
     */
    public TransferStructuredAddress withTransmitterIdentifier(@Nonnull String transmitterIdentifier) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransferStructuredAddress other = (TransferStructuredAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransferStructuredAddress.class,
                "line1", line1,
                "line2", line2,
    ...
    public final static class Builder {
        ...
        public TransferStructuredAddress build() {
            return new TransferStructuredAddress(
                line1, line2, buildingNumber,
                streetName, city, state,
                postalCode, country, name,
                transmitterIdentifier);
