...
public class PostCombinedTransfersInstantPaymentCounterpartyAddress {
    /**
    ...
    @JsonCreator
    public PostCombinedTransfersInstantPaymentCounterpartyAddress(
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public PostCombinedTransfersInstantPaymentCounterpartyAddress withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for counterparty address
     */
    public PostCombinedTransfersInstantPaymentCounterpartyAddress withStreet1(@Nonnull String street1) {
     ...
     * Optional second line of street
     */
    public PostCombinedTransfersInstantPaymentCounterpartyAddress withStreet2(@Nullable String street2) {
        this.street2 = street2;
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public PostCombinedTransfersInstantPaymentCounterpartyAddress withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public PostCombinedTransfersInstantPaymentCounterpartyAddress withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public PostCombinedTransfersInstantPaymentCounterpartyAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public PostCombinedTransfersInstantPaymentCounterpartyAddress withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostCombinedTransfersInstantPaymentCounterpartyAddress other = (PostCombinedTransfersInstantPaymentCounterpartyAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PostCombinedTransfersInstantPaymentCounterpartyAddress.class,
    ...
    public final static class Builder {
        ...
        public PostCombinedTransfersInstantPaymentCounterpartyAddress build() {
            return new PostCombinedTransfersInstantPaymentCounterpartyAddress(
                streetNumber, street1, street2,
                city, state, postalCode,
                country);
        }
