 ...
 */
public class ListTransfersInstantPaymentTransmitter {
    /**
    ...
    @JsonCreator
    public ListTransfersInstantPaymentTransmitter(
     ...
     * Name of the Transmitter.
     */
    public ListTransfersInstantPaymentTransmitter withName(@Nonnull String name) {
     ...
     * Up to 24 characters, and supplied by Transmitter. Alphanumeric only.
     */
    public ListTransfersInstantPaymentTransmitter withTransmitterIdentifier(@Nonnull String transmitterIdentifier) {
     ...
     * Building number for Transmitter address. Alphanumeric only.
     */
    public ListTransfersInstantPaymentTransmitter withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for Transmitter address
     */
    public ListTransfersInstantPaymentTransmitter withStreet1(@Nonnull String street1) {
     ...
     * Maximum 35 characters
     */
    public ListTransfersInstantPaymentTransmitter withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public ListTransfersInstantPaymentTransmitter withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public ListTransfersInstantPaymentTransmitter withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public ListTransfersInstantPaymentTransmitter withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListTransfersInstantPaymentTransmitter other = (ListTransfersInstantPaymentTransmitter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListTransfersInstantPaymentTransmitter.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public ListTransfersInstantPaymentTransmitter build() {
            return new ListTransfersInstantPaymentTransmitter(
                name, transmitterIdentifier, streetNumber,
                street1, city, state,
                postalCode, country);
        }
