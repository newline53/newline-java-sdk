...
public class GetTransactionsUidInstantPaymentCounterpartyAddress {
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for counterparty address
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withStreet1(@Nonnull String street1) {
