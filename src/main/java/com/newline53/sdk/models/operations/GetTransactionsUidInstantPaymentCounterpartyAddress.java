 ...
 */
public class GetTransactionsUidInstantPaymentCounterpartyAddress {
    /**
    ...
    @JsonCreator
    public GetTransactionsUidInstantPaymentCounterpartyAddress(
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withStreetNumber(@Nullable String streetNumber) {
        this.streetNumber = JsonNullable.of(streetNumber);
        return this;
    }
     ...
     * Street name for counterparty address
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withStreet1(@Nullable String street1) {
        this.street1 = JsonNullable.of(street1);
        return this;
    }
     ...
     * Optional second line of street
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withStreet2(@Nullable String street2) {
        this.street2 = street2;
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public GetTransactionsUidInstantPaymentCounterpartyAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public GetTransactionsUidInstantPaymentCounterpartyAddress withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTransactionsUidInstantPaymentCounterpartyAddress other = (GetTransactionsUidInstantPaymentCounterpartyAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTransactionsUidInstantPaymentCounterpartyAddress.class,
    ...
    public final static class Builder {
        ...
        public GetTransactionsUidInstantPaymentCounterpartyAddress build() {
            return new GetTransactionsUidInstantPaymentCounterpartyAddress(
                streetNumber, street1, street2,
                city, state, postalCode,
                country);
        }
