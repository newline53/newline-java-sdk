...
public class CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest {
    /**
    ...
    @JsonCreator
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest(
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for counterparty address
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest withStreet1(@Nonnull String street1) {
     ...
     * Optional second line of street
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest withStreet2(@Nullable String street2) {
        this.street2 = street2;
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest other = (CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest.class,
    ...
    public final static class Builder {
        ...
        public CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest build() {
            return new CreateSyntheticAccountInstantPaymentCounterpartyAddressRequest(
                streetNumber, street1, street2,
                city, state, postalCode,
                country);
        }
