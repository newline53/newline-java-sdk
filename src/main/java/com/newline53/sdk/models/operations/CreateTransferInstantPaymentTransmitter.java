...
public class CreateTransferInstantPaymentTransmitter {
    ...
    @JsonCreator
    public CreateTransferInstantPaymentTransmitter(
     ...
     * Name of the Transmitter.
     */
    public CreateTransferInstantPaymentTransmitter withName(@Nonnull String name) {
     ...
     * Up to 24 characters, and supplied by Transmitter. Alphanumeric only.
     */
    public CreateTransferInstantPaymentTransmitter withTransmitterIdentifier(@Nonnull String transmitterIdentifier) {
     ...
     * Building number for Transmitter address. Alphanumeric only.
     */
    public CreateTransferInstantPaymentTransmitter withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for Transmitter address
     */
    public CreateTransferInstantPaymentTransmitter withStreet1(@Nonnull String street1) {
     ...
     * Maximum 35 characters
     */
    public CreateTransferInstantPaymentTransmitter withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public CreateTransferInstantPaymentTransmitter withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public CreateTransferInstantPaymentTransmitter withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public CreateTransferInstantPaymentTransmitter withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateTransferInstantPaymentTransmitter other = (CreateTransferInstantPaymentTransmitter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateTransferInstantPaymentTransmitter.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public CreateTransferInstantPaymentTransmitter build() {
            return new CreateTransferInstantPaymentTransmitter(
                name, transmitterIdentifier, streetNumber,
                street1, city, state,
                postalCode, country);
        }
