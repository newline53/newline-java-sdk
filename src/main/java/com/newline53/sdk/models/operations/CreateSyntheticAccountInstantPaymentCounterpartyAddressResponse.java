...
public class CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse {
    /**
    ...
    @JsonCreator
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse(
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withStreetNumber(@Nullable String streetNumber) {
        this.streetNumber = JsonNullable.of(streetNumber);
        return this;
    }
     ...
     * Street name for counterparty address
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withStreet1(@Nullable String street1) {
        this.street1 = JsonNullable.of(street1);
        return this;
    }
     ...
     * Optional second line of street
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withStreet2(@Nullable String street2) {
        this.street2 = street2;
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse other = (CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse.class,
    ...
    public final static class Builder {
        ...
        public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse build() {
            return new CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse(
                streetNumber, street1, street2,
                city, state, postalCode,
                country);
        }
