...
public class CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse {
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for counterparty address
     */
    public CreateSyntheticAccountInstantPaymentCounterpartyAddressResponse withStreet1(@Nonnull String street1) {
