 ...
 */
public class PutTransfersUidCancelWireTransmitter {
    /**
    ...
    @JsonCreator
    public PutTransfersUidCancelWireTransmitter(
     ...
     * Name of the Transmitter.
     */
    public PutTransfersUidCancelWireTransmitter withName(@Nonnull String name) {
     ...
     * Up to 24 digits, supplied by Transmitter. Numeric only.
     */
    public PutTransfersUidCancelWireTransmitter withTransmitterIdentifier(@Nonnull String transmitterIdentifier) {
     ...
     * Optional 35 characters. Cannot contain \# @ $! " % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public PutTransfersUidCancelWireTransmitter withLine1(@Nullable String line1) {
     ...
     * Optional 35 characters. Cannot contain \# @ $! " % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public PutTransfersUidCancelWireTransmitter withLine2(@Nullable String line2) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public PutTransfersUidCancelWireTransmitter withLine3(@Nullable String line3) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public PutTransfersUidCancelWireTransmitter withBuildingNumber(@Nullable String buildingNumber) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public PutTransfersUidCancelWireTransmitter withStreetName(@Nullable String streetName) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public PutTransfersUidCancelWireTransmitter withCity(@Nullable String city) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public PutTransfersUidCancelWireTransmitter withState(@Nullable String state) {
     ...
     * US ZIP code (5-digit) or ZIP+4.
     */
    public PutTransfersUidCancelWireTransmitter withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public PutTransfersUidCancelWireTransmitter withCountry(@Nullable String country) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PutTransfersUidCancelWireTransmitter other = (PutTransfersUidCancelWireTransmitter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PutTransfersUidCancelWireTransmitter.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public PutTransfersUidCancelWireTransmitter build() {
            return new PutTransfersUidCancelWireTransmitter(
                name, transmitterIdentifier, line1,
                line2, line3, buildingNumber,
                streetName, city, state,
                postalCode, country);
