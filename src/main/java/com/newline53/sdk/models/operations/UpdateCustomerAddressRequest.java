...
public class UpdateCustomerAddressRequest {
     ...
     * Maximum 35 characters
     */
    public UpdateCustomerAddressRequest withStreet1(@Nullable String street1) {
        this.street1 = JsonNullable.of(street1);
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public UpdateCustomerAddressRequest withStreet2(@Nullable String street2) {
     ...
     * Maximum 35 characters
     */
    public UpdateCustomerAddressRequest withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public UpdateCustomerAddressRequest withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public UpdateCustomerAddressRequest withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCustomerAddressRequest other = (UpdateCustomerAddressRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateCustomerAddressRequest.class,
                "street1", street1,
                "street2", street2,
                "city", city,
                "state", state,
    ...
    public final static class Builder {
        ...
        public UpdateCustomerAddressRequest build() {
