...
public class GetSyntheticAccountInstantPaymentCounterpartyAddress {
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public GetSyntheticAccountInstantPaymentCounterpartyAddress withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for counterparty address
     */
    public GetSyntheticAccountInstantPaymentCounterpartyAddress withStreet1(@Nonnull String street1) {
