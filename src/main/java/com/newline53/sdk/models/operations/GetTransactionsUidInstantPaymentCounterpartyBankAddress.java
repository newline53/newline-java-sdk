...
public class GetTransactionsUidInstantPaymentCounterpartyBankAddress {
    ...
    @JsonCreator
    public GetTransactionsUidInstantPaymentCounterpartyBankAddress(
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public GetTransactionsUidInstantPaymentCounterpartyBankAddress withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for counterparty address
     */
    public GetTransactionsUidInstantPaymentCounterpartyBankAddress withStreet1(@Nonnull String street1) {
     ...
     * Optional second line of street
     */
    public GetTransactionsUidInstantPaymentCounterpartyBankAddress withStreet2(@Nullable String street2) {
        this.street2 = street2;
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public GetTransactionsUidInstantPaymentCounterpartyBankAddress withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public GetTransactionsUidInstantPaymentCounterpartyBankAddress withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public GetTransactionsUidInstantPaymentCounterpartyBankAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public GetTransactionsUidInstantPaymentCounterpartyBankAddress withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTransactionsUidInstantPaymentCounterpartyBankAddress other = (GetTransactionsUidInstantPaymentCounterpartyBankAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTransactionsUidInstantPaymentCounterpartyBankAddress.class,
    ...
    public final static class Builder {
        ...
        public GetTransactionsUidInstantPaymentCounterpartyBankAddress build() {
            return new GetTransactionsUidInstantPaymentCounterpartyBankAddress(
                streetNumber, street1, street2,
                city, state, postalCode,
                country);
        }
