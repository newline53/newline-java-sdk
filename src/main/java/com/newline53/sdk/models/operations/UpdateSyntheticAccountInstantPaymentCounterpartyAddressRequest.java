...
public class UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest {
    /**
    ...
    @JsonCreator
    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest(
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest withStreetNumber(@Nonnull String streetNumber) {
     ...
     * Street name for counterparty address
     */
    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest withStreet1(@Nonnull String street1) {
     ...
     * Optional second line of street
     */
    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest withStreet2(@Nullable String street2) {
        this.street2 = street2;
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest other = (UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest.class,
    ...
    public final static class Builder {
        ...
        public UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest build() {
            return new UpdateSyntheticAccountInstantPaymentCounterpartyAddressRequest(
                streetNumber, street1, street2,
                city, state, postalCode,
                country);
        }
