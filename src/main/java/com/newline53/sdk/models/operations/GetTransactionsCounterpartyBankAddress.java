...
/**
 * GetTransactionsCounterpartyBankAddress
 * 
 * <p>Address of the financial institution where the external account is held.
 */
public class GetTransactionsCounterpartyBankAddress {
    /**
    ...
    @JsonCreator
    public GetTransactionsCounterpartyBankAddress(
     ...
     * Building number for counterparty address. Alphanumeric only.
     */
    public GetTransactionsCounterpartyBankAddress withStreetNumber(@Nullable String streetNumber) {
        this.streetNumber = JsonNullable.of(streetNumber);
        return this;
    }
     ...
     * Street name for counterparty address
     */
    public GetTransactionsCounterpartyBankAddress withStreet1(@Nullable String street1) {
        this.street1 = JsonNullable.of(street1);
        return this;
    }
     ...
     * Optional second line of street
     */
    public GetTransactionsCounterpartyBankAddress withStreet2(@Nullable String street2) {
        this.street2 = street2;
        return this;
    }
     ...
     * Maximum 35 characters
     */
    public GetTransactionsCounterpartyBankAddress withCity(@Nullable String city) {
        this.city = JsonNullable.of(city);
        return this;
    }
     ...
     * 2 characters. Must be a valid US state abbreviation.
     */
    public GetTransactionsCounterpartyBankAddress withState(@Nullable String state) {
        this.state = JsonNullable.of(state);
        return this;
    }
     ...
     * 5-digit string. ZIP+4 is allowed.
     */
    public GetTransactionsCounterpartyBankAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public GetTransactionsCounterpartyBankAddress withCountry(@Nullable String country) {
        this.country = JsonNullable.of(country);
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTransactionsCounterpartyBankAddress other = (GetTransactionsCounterpartyBankAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTransactionsCounterpartyBankAddress.class,
    ...
    public final static class Builder {
        ...
        public GetTransactionsCounterpartyBankAddress build() {
            return new GetTransactionsCounterpartyBankAddress(
                streetNumber, street1, street2,
                city, state, postalCode,
                country);
        }
