...
public class ListTransfersWireTransmitter {
    ...
    @JsonCreator
    public ListTransfersWireTransmitter(
     ...
     * Name of the Transmitter.
     */
    public ListTransfersWireTransmitter withName(@Nonnull String name) {
     ...
     * Up to 24 digits, supplied by Transmitter. Numeric only.
     */
    public ListTransfersWireTransmitter withTransmitterIdentifier(@Nonnull String transmitterIdentifier) {
     ...
     * Optional 35 characters. Cannot contain \# @ $! " % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public ListTransfersWireTransmitter withLine1(@Nullable String line1) {
     ...
     * Optional 35 characters. Cannot contain \# @ $! " % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public ListTransfersWireTransmitter withLine2(@Nullable String line2) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public ListTransfersWireTransmitter withLine3(@Nullable String line3) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public ListTransfersWireTransmitter withBuildingNumber(@Nullable String buildingNumber) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public ListTransfersWireTransmitter withStreetName(@Nullable String streetName) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public ListTransfersWireTransmitter withCity(@Nullable String city) {
     ...
     * <p>" % &amp; * ; &lt; &gt; { } [ ] _ ^ \ ~
     */
    public ListTransfersWireTransmitter withState(@Nullable String state) {
     ...
     * US ZIP code (5-digit) or ZIP+4.
     */
    public ListTransfersWireTransmitter withPostalCode(@Nullable String postalCode) {
        this.postalCode = JsonNullable.of(postalCode);
        return this;
    }


    public ListTransfersWireTransmitter withCountry(@Nullable String country) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListTransfersWireTransmitter other = (ListTransfersWireTransmitter) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListTransfersWireTransmitter.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public ListTransfersWireTransmitter build() {
            return new ListTransfersWireTransmitter(
                name, transmitterIdentifier, line1,
                line2, line3, buildingNumber,
                streetName, city, state,
                postalCode, country);
