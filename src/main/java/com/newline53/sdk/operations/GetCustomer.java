...
import com.newline53.sdk.models.operations.GetCustomerResponseBody;
...
public class GetCustomer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCustomerRequest request) {
        ...
        @Override
        public GetCustomerResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCustomerRequest, com.newline53.sdk.models.operations.async.GetCustomerResponse> {
        ...
        @Override
        public CompletableFuture<com.newline53.sdk.models.operations.async.GetCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.newline53.sdk.models.operations.async.GetCustomerResponse.Builder resBuilder =
                    com.newline53.sdk.models.operations.async.GetCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.newline53.sdk.models.operations.async.GetCustomerResponse res = resBuilder.build();
