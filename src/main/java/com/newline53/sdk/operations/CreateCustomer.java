...
import com.newline53.sdk.models.operations.CreateCustomerResponseBody;
...
public class CreateCustomer {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCustomerRequest request) {
        ...
        @Override
        public CreateCustomerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateCustomerResponse.Builder resBuilder =
            ...
            CreateCustomerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateCustomerResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCustomerRequest, com.newline53.sdk.models.operations.async.CreateCustomerResponse> {
        ...
        @Override
        public CompletableFuture<com.newline53.sdk.models.operations.async.CreateCustomerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.newline53.sdk.models.operations.async.CreateCustomerResponse.Builder resBuilder =
                    com.newline53.sdk.models.operations.async.CreateCustomerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.newline53.sdk.models.operations.async.CreateCustomerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateCustomerResponseBody>() {})
