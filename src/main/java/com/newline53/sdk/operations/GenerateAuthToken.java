...
import com.newline53.sdk.models.operations.GenerateAuthTokenResponseBody;
...
public class GenerateAuthToken {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GenerateAuthTokenResponse> {
        ...
        @Override
        public GenerateAuthTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GenerateAuthTokenResponse.Builder resBuilder =
            ...
            GenerateAuthTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GenerateAuthTokenResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.newline53.sdk.models.operations.async.GenerateAuthTokenResponse> {
        ...
        @Override
        public CompletableFuture<com.newline53.sdk.models.operations.async.GenerateAuthTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.newline53.sdk.models.operations.async.GenerateAuthTokenResponse.Builder resBuilder =
                    com.newline53.sdk.models.operations.async.GenerateAuthTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.newline53.sdk.models.operations.async.GenerateAuthTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GenerateAuthTokenResponseBody>() {})
