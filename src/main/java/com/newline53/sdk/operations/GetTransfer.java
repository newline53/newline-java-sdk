...
import com.newline53.sdk.models.operations.GetTransferResponseBody;
...
public class GetTransfer {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransferRequest, GetTransferResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransferRequest request) {
        ...
        @Override
        public GetTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransferResponse.Builder resBuilder =
                    GetTransferResponse
                            .builder()
            ...
            GetTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetTransferResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransferRequest, com.newline53.sdk.models.operations.async.GetTransferResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransferRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.newline53.sdk.models.operations.async.GetTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.newline53.sdk.models.operations.async.GetTransferResponse.Builder resBuilder =
                    com.newline53.sdk.models.operations.async.GetTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.newline53.sdk.models.operations.async.GetTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTransferResponseBody>() {})
