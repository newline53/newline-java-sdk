...
import com.newline53.sdk.models.operations.CreateTransferResponseBody;
...
public class CreateTransfer {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateTransferRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTransferRequest request) {
        ...
        @Override
        public CreateTransferResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateTransferResponse.Builder resBuilder =
            ...
            CreateTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateTransferResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateTransferRequest, com.newline53.sdk.models.operations.async.CreateTransferResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateTransferRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateTransferRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTransferRequest request) {
        ...
        @Override
        public CompletableFuture<com.newline53.sdk.models.operations.async.CreateTransferResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.newline53.sdk.models.operations.async.CreateTransferResponse.Builder resBuilder =
                    com.newline53.sdk.models.operations.async.CreateTransferResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.newline53.sdk.models.operations.async.CreateTransferResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateTransferResponseBody>() {})
