...
```java
import com.newline53.sdk.models.operations.GetTransactionsUidPurposeOfPayment;

GetTransactionsUidPurposeOfPayment value = GetTransactionsUidPurposeOfPayment.NOWS;

// Open enum: use .of() to create instances from custom string values
GetTransactionsUidPurposeOfPayment custom = GetTransactionsUidPurposeOfPayment.of("custom_value");
```
