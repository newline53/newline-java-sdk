...
```java
import com.newline53.sdk.models.operations.CreateCustomerKycStatus;

CreateCustomerKycStatus value = CreateCustomerKycStatus.MANUAL_REVIEW;

// Open enum: use .of() to create instances from custom string values
CreateCustomerKycStatus custom = CreateCustomerKycStatus.of("custom_value");
```
