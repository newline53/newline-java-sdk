...
```java
import com.newline53.sdk.models.operations.DataKycStatus;

DataKycStatus value = DataKycStatus.MANUAL_REVIEW;

// Open enum: use .of() to create instances from custom string values
DataKycStatus custom = DataKycStatus.of("custom_value");
```
