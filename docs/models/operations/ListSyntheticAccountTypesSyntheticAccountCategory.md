...
```java
import com.newline53.sdk.models.operations.ListSyntheticAccountTypesSyntheticAccountCategory;

ListSyntheticAccountTypesSyntheticAccountCategory value = ListSyntheticAccountTypesSyntheticAccountCategory.GENERAL;

// Open enum: use .of() to create instances from custom string values
ListSyntheticAccountTypesSyntheticAccountCategory custom = ListSyntheticAccountTypesSyntheticAccountCategory.of("custom_value");
```
