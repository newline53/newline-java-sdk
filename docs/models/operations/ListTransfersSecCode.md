...
```java
import com.newline53.sdk.models.operations.ListTransfersSecCode;

ListTransfersSecCode value = ListTransfersSecCode.CCD;

// Open enum: use .of() to create instances from custom string values
ListTransfersSecCode custom = ListTransfersSecCode.of("custom_value");
```
