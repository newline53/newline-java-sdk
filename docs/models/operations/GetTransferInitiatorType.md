...
```java
import com.newline53.sdk.models.operations.GetTransferInitiatorType;

GetTransferInitiatorType value = GetTransferInitiatorType.CUSTOMER;

// Open enum: use .of() to create instances from custom string values
GetTransferInitiatorType custom = GetTransferInitiatorType.of("custom_value");
```
