...
```java
import com.newline53.sdk.models.operations.GetTransactionsSecCode;

GetTransactionsSecCode value = GetTransactionsSecCode.CCD;

// Open enum: use .of() to create instances from custom string values
GetTransactionsSecCode custom = GetTransactionsSecCode.of("custom_value");
```
