...
```java
import com.newline53.sdk.models.operations.CreateTransferInitiatorTypeResponse;

CreateTransferInitiatorTypeResponse value = CreateTransferInitiatorTypeResponse.CUSTOMER;

// Open enum: use .of() to create instances from custom string values
CreateTransferInitiatorTypeResponse custom = CreateTransferInitiatorTypeResponse.of("custom_value");
```
