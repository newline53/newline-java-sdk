...
```java
import com.newline53.sdk.models.operations.GetTransactionsUidAuthorizationStatus;

GetTransactionsUidAuthorizationStatus value = GetTransactionsUidAuthorizationStatus.AUTO_APPROVED;

// Open enum: use .of() to create instances from custom string values
GetTransactionsUidAuthorizationStatus custom = GetTransactionsUidAuthorizationStatus.of("custom_value");
```
