...
```java
import com.newline53.sdk.models.operations.GetTransactionsDataStatus;

GetTransactionsDataStatus value = GetTransactionsDataStatus.CANCELED;

// Open enum: use .of() to create instances from custom string values
GetTransactionsDataStatus custom = GetTransactionsDataStatus.of("custom_value");
```
