...
```java
import com.newline53.sdk.models.operations.GetTransferPurposeOfPayment;

GetTransferPurposeOfPayment value = GetTransferPurposeOfPayment.NOWS;

// Open enum: use .of() to create instances from custom string values
GetTransferPurposeOfPayment custom = GetTransferPurposeOfPayment.of("custom_value");
```
