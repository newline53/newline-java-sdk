...
```java
import com.newline53.sdk.models.operations.GetCustomerKycStatusReason;

GetCustomerKycStatusReason value = GetCustomerKycStatusReason.APPROVED;

// Open enum: use .of() to create instances from custom string values
GetCustomerKycStatusReason custom = GetCustomerKycStatusReason.of("custom_value");
```
