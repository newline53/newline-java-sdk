...
```java
import com.newline53.sdk.models.operations.ListCustomersKycStatusReason;

ListCustomersKycStatusReason value = ListCustomersKycStatusReason.APPROVED;

// Open enum: use .of() to create instances from custom string values
ListCustomersKycStatusReason custom = ListCustomersKycStatusReason.of("custom_value");
```
