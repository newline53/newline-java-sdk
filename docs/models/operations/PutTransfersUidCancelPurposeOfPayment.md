...
```java
import com.newline53.sdk.models.operations.PutTransfersUidCancelPurposeOfPayment;

PutTransfersUidCancelPurposeOfPayment value = PutTransfersUidCancelPurposeOfPayment.NOWS;

// Open enum: use .of() to create instances from custom string values
PutTransfersUidCancelPurposeOfPayment custom = PutTransfersUidCancelPurposeOfPayment.of("custom_value");
```
