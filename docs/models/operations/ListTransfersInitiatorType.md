...
```java
import com.newline53.sdk.models.operations.ListTransfersInitiatorType;

ListTransfersInitiatorType value = ListTransfersInitiatorType.CUSTOMER;

// Open enum: use .of() to create instances from custom string values
ListTransfersInitiatorType custom = ListTransfersInitiatorType.of("custom_value");
```
