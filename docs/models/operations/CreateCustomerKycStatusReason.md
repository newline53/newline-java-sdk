...
```java
import com.newline53.sdk.models.operations.CreateCustomerKycStatusReason;

CreateCustomerKycStatusReason value = CreateCustomerKycStatusReason.APPROVED;

// Open enum: use .of() to create instances from custom string values
CreateCustomerKycStatusReason custom = CreateCustomerKycStatusReason.of("custom_value");
```
