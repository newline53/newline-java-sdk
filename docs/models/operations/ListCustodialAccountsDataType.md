...
```java
import com.newline53.sdk.models.operations.ListCustodialAccountsDataType;

ListCustodialAccountsDataType value = ListCustodialAccountsDataType.DDA;

// Open enum: use .of() to create instances from custom string values
ListCustodialAccountsDataType custom = ListCustodialAccountsDataType.of("custom_value");
```
