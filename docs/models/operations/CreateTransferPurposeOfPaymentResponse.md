...
```java
import com.newline53.sdk.models.operations.CreateTransferPurposeOfPaymentResponse;

CreateTransferPurposeOfPaymentResponse value = CreateTransferPurposeOfPaymentResponse.NOWS;

// Open enum: use .of() to create instances from custom string values
CreateTransferPurposeOfPaymentResponse custom = CreateTransferPurposeOfPaymentResponse.of("custom_value");
```
