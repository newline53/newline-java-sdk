...
```java
import com.newline53.sdk.models.operations.GetTransactionsDataType;

GetTransactionsDataType value = GetTransactionsDataType.ACH;

// Open enum: use .of() to create instances from custom string values
GetTransactionsDataType custom = GetTransactionsDataType.of("custom_value");
```
