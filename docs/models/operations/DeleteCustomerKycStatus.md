...
```java
import com.newline53.sdk.models.operations.DeleteCustomerKycStatus;

DeleteCustomerKycStatus value = DeleteCustomerKycStatus.MANUAL_REVIEW;

// Open enum: use .of() to create instances from custom string values
DeleteCustomerKycStatus custom = DeleteCustomerKycStatus.of("custom_value");
```
