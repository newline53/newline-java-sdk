...
```java
import com.newline53.sdk.models.operations.UpdateCustomerKycStatusReason;

UpdateCustomerKycStatusReason value = UpdateCustomerKycStatusReason.APPROVED;

// Open enum: use .of() to create instances from custom string values
UpdateCustomerKycStatusReason custom = UpdateCustomerKycStatusReason.of("custom_value");
```
