...
```java
import com.newline53.sdk.models.operations.GetTransactionsPurposeOfPayment;

GetTransactionsPurposeOfPayment value = GetTransactionsPurposeOfPayment.NOWS;

// Open enum: use .of() to create instances from custom string values
GetTransactionsPurposeOfPayment custom = GetTransactionsPurposeOfPayment.of("custom_value");
```
