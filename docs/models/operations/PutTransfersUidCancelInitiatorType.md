...
```java
import com.newline53.sdk.models.operations.PutTransfersUidCancelInitiatorType;

PutTransfersUidCancelInitiatorType value = PutTransfersUidCancelInitiatorType.CUSTOMER;

// Open enum: use .of() to create instances from custom string values
PutTransfersUidCancelInitiatorType custom = PutTransfersUidCancelInitiatorType.of("custom_value");
```
