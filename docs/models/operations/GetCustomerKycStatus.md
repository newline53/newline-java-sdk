...
```java
import com.newline53.sdk.models.operations.GetCustomerKycStatus;

GetCustomerKycStatus value = GetCustomerKycStatus.MANUAL_REVIEW;

// Open enum: use .of() to create instances from custom string values
GetCustomerKycStatus custom = GetCustomerKycStatus.of("custom_value");
```
